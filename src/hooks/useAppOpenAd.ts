...
import { AdsKeyword, EVENTS } from '../constant';
  ...
  const showAppOpenAd = async (
    ...
    try {
      ...
      if (remoteData?.admobAppOpenId) {
        ...
        ad.addAdEventListener(AdEventType.PAID, (adValue: any) => {
          if (!adValue) return;
          ...
          const params = {
            ...
            type: EVENTS.APP_OPEN_AD_IMPRESSION,
          };

          // Log to Firebase
          logFirebaseEvent(EVENTS.AD_IMPRESSION, params);
