...
export const GIRLFRIEND_THEME: CupidTheme = {
  name: 'girlfriend',
...
export const BOYFRIEND_THEME: CupidTheme = {
  name: 'boyfriend',
...
export const GIRLFRIEND_DARK_THEME: CupidTheme = {
...
export const BOYFRIEND_DARK_THEME: CupidTheme = {
  name: 'boyfriend-dark',
  primaryFriend: '#00B1E3',
  primaryLightFriend: '#39D6FD',
