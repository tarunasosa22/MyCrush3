...
import { getTokensInfo } from '../api/user';
import { subscriptionSubTypes, subscriptionTypes } from '../constants';
import { CupidThemeName } from '../theme/themes';
import { AvatarItem } from './categoryStore';
import { createPersistZustand } from './store';

export type ProductSubscriptionPlans = {
...
export type LoginData = {
  ...
  active_subscription_detail?: {
    id: string | null;
    plan_name: subscriptionTypes | null;
...
export type userSelfAvaterCategoryOption = {
  id: number;
  label: string | null;
  image: string | null;
  audio: string | null;
};
export type userSelfAvatarCategory = {
  category_id: number;
  input_type: string | null;
  label: string | null;
  options: userSelfAvaterCategoryOption[];
};
...
export type userSelfAvatar = {
  id: string;
  categories: userSelfAvatarCategory[];
  cover_image: string | null;
  created_at: string | null;
...
interface AuthState {
  userData: UserType;
  isGuestUser: boolean;
  favoritesList: AvatarItem[];
  myFavoritesList: AvatarItem[];
  myAvatars: AvatarItem[] | undefined;
  isOpenPlan?: boolean;
  isAdsOpenPlan?: boolean;
  isAdsPlanPurchasedUser?: boolean;
  selectedPlan: subscriptionSubTypes | undefined;
  selectedIAPPlan: ProductPack | undefined;
  selectedAdsIAPPlan: ProductPack | undefined;
  homeAvatarList?: AvatarItem[] | undefined;
...
interface otherAuthState {
  ...
  productSubscriptionPlans: ProductSubscriptionPlans[] | undefined;
  productIAPIds: string[] | undefined;
  productIAPPlans: ProductIAPPlans[] | undefined;
  isAppReady: boolean;
  splashState: boolean;
  isAdClosed: boolean;
...
interface AuthActions {
  ...
  setLogout: () => void;
  setFavoritesList: (favoritesItem: AvatarItem) => void;
  setMyFavoritesList: (myFavoritesItem: AvatarItem) => void;
  setMyAvatars: (myAvatars: AvatarItem[]) => void;
  ...
  setUserSelectedPlan: (plan: subscriptionSubTypes | undefined) => void;
  ...
  setHomeAvatarList: (homeAvatarList: AvatarItem[] | undefined) => void;
  ...
  setProductIAPPlans: (productIAPPlans: ProductIAPPlans[] | undefined) => void;
...
export const userState = createPersistZustand<UserStateType>(
  ...
  (set, get) => ({
    ...
    setFavoritesList: (favoritesItem: AvatarItem) => {
    ...
    setMyFavoritesList: (favoritesItem: AvatarItem) => {
    ...
    setMyAvatars: (myAvatars: AvatarItem[] | undefined) => {
    ...
    setHomeAvatarList: (avatarList: AvatarItem[] | undefined) => {
    ...
    setProductIAPPlans: (productIAPPlans: ProductIAPPlans[] | undefined) => {
